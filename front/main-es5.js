...
var navbar_aComponent = /** @class */ (function () {
    function navbar_aComponent(location, element, router) {
    ...
    navbar_aComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        var navbar_a = this.element.nativeElement;
    ...
    navbar_aComponent.prototype.sidebarOpen = function () {
    ...
    ;
    navbar_aComponent.prototype.sidebarClose = function () {
        var body = document.getElementsByTagName('body')[0];
    ...
    ;
    navbar_aComponent.prototype.sidebarToggle = function () {
    ...
    ;
    navbar_aComponent.prototype.getTitle = function () {
    ...
    navbar_aComponent.ctorParameters = function () { return [
...
var AdminLayoutComponent = /** @class */ (function () {
    ...
    AdminLayoutComponent.prototype.ngOnInit = function () {
        ...
        var $sidebar_responsive = jquery__WEBPACK_IMPORTED_MODULE_5__('body > .navbar_a-collapse');
...
/* harmony import */ var ngx_toggle_switch__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ngx-toggle-switch */ "./node_modules/ngx-toggle-switch/ui-switch.es5.js");
...
/* harmony import */ var _ngmodule_material_carousel__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @ngmodule/material-carousel */ "./node_modules/@ngmodule/material-carousel/fesm5/ngmodule-material-carousel.js");
...
/* harmony import */ var ngx_editor__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ngx-editor */ "./node_modules/ngx-editor/fesm5/ngx-editor.js");
...
/* harmony import */ var angular_bootstrap_md__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! angular-bootstrap-md */ "./node_modules/angular-bootstrap-md/fesm5/angular-bootstrap-md.js");
...
/* harmony import */ var _ctrl_ngx_emoji_mart__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! @ctrl/ngx-emoji-mart */ "./node_modules/@ctrl/ngx-emoji-mart/fesm5/ctrl-ngx-emoji-mart.js");
...
/* harmony import */ var ngx_popper__WEBPACK_IMPORTED_MODULE_74__ = __webpack_require__(/*! ngx-popper */ "./node_modules/ngx-popper/fesm5/ngx-popper.js");
/* harmony import */ var ng2_dragula__WEBPACK_IMPORTED_MODULE_75__ = __webpack_require__(/*! ng2-dragula */ "./node_modules/ng2-dragula/dist/fesm5/ng2-dragula.js");
/* harmony import */ var _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_76__ = __webpack_require__(/*! @angular/material/progress-bar */ "./node_modules/@angular/material/esm5/progress-bar.es5.js");
/* harmony import */ var _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_77__ = __webpack_require__(/*! @angular/material/datepicker */ "./node_modules/@angular/material/esm5/datepicker.es5.js");
...
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_84__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm5/ngx-toastr.js");
...
var ChangePasswordComponent = /** @class */ (function () {
    function ChangePasswordComponent(route, formBuilder, usersService, router) {
        this.route = route;
    ...
    ChangePasswordComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            ...
            _this.usersService.verifyResetKey(reset_key, function (res) {
                if (res.success == 1) {
                    _this.verified = true;
                    localStorage.setItem('user_id', res.data.user_id);
                    _this.reset_key = _this.route.snapshot.paramMap.get('id');
                }
    ...
    Object.defineProperty(ChangePasswordComponent.prototype, "f_up", {
        get: function () {
    ...
    ChangePasswordComponent.prototype.onChangePassword = function () {
        ...
        this.usersService.resetPassword(localStorage.getItem('user_id'), this.registerForm.value.password, this.reset_key, function (res) {
            if (res.success == 1) {
...
var SignComponent = /** @class */ (function () {
    function SignComponent(formBuilder, usersService, exchangeService, mapService, router) {
        this.formBuilder = formBuilder;
        this.usersService = usersService;
    ...
    SignComponent.prototype.ngOnInit = function () {
        ...
        this.mapService.getLocation().subscribe(function (data) {
            ...
            _this.address = data.city;
            _this.state = data.continent_code;
        });
    };
    SignComponent.prototype.onCheck = function (id) {
        $('#' + id).prop("checked", false);
    };
    Object.defineProperty(SignComponent.prototype, "f_up", {
    ...
    Object.defineProperty(SignComponent.prototype, "f_in", {
        get: function () {
    ...
    SignComponent.prototype.onSignin = function () {
        var _this = this;
        this.signin = true;
        // stop here if form is invalid
        ...
        this.usersService.signin(userInfo.email, userInfo.password, function (res) {
            if (res.success == 1) {
                ...
                _this.signin_error = res.message;
            }
        });
        // alert('SUCCESS!! :-)\n\n' + JSON.stringify(this.loginForm.value))
    };
    SignComponent.prototype.onSignup = function () {
        var _this = this;
        this.signup = true;
        // stop here if form is invalid
        if (this.registerForm.invalid) {
        ...
        this.usersService.signup(userInfo.email, userInfo.firstName, userInfo.lastName, userInfo.password, userInfo.advertise, location, function (res) {
            if (res.success == 1) {
                localStorage.setItem('token', res.data.token);
                localStorage.setItem('user_id', res.data.user_id);
                ...
                _this.signup_error = res.message;
            }
        });
        this.exchangeService.changeMessage(userInfo.email);
    };
    SignComponent.prototype.forgot_password = function () {
        var _this = this;
        var userInfo = this.loginForm.value;
        this.usersService.forgot_password(userInfo.email, function (res) {
            if (res.success == 1) {
                _this.sent_success = res.message;
                _this.signin_error = '';
            }
            else if (res.success == -1) {
                _this.router.navigate['sign'];
...
var HomeGalleryComponent = /** @class */ (function () {
    ...
    HomeGalleryComponent.prototype.selectAd = function (id) {
...
var HomeLockComponent = /** @class */ (function () {
    function HomeLockComponent() {
    }
    HomeLockComponent.prototype.ngOnInit = function () {
    };
...
var HomeRecentProfilesComponent = /** @class */ (function () {
    ...
    HomeRecentProfilesComponent.prototype.selectAd = function (id) {
        localStorage.setItem('view_id', id);
        this.exchangeService.openViewProfile(id);
    };
    ...
    return HomeRecentProfilesComponent;
}());
...
var HomeReportComponent = /** @class */ (function () {
    function HomeReportComponent() {
    }
    HomeReportComponent.prototype.ngOnInit = function () {
    };
...
var HomeSearchHereComponent = /** @class */ (function () {
    function HomeSearchHereComponent() {
    }
    HomeSearchHereComponent.prototype.ngOnInit = function () { };
    HomeSearchHereComponent.prototype.changeValue = function (event) {
        this.fields[event.index] = event.val;
    };
    HomeSearchHereComponent.prototype.onCheck = function (event) {
    ...
    return HomeSearchHereComponent;
}());
...
var HomeTopProfileComponent = /** @class */ (function () {
    function HomeTopProfileComponent(exchangeService, usersService) {
        this.exchangeService = exchangeService;
        this.usersService = usersService;
    ...
    HomeTopProfileComponent.prototype.ngOnInit = function () {
    ...
    HomeTopProfileComponent.prototype.rightImage = function () {
        //   this.images = [];
        //   setTimeout (() => {
    ...
    HomeTopProfileComponent.prototype.leftImage = function () {
        //   this.images = [];
        //   setTimeout (() => {
        //     this.currentPosition--;
        //     for(var i = 0; i < this.all[this.currentPosition].length; i++){
    ...
    HomeTopProfileComponent.prototype.selectAd = function (id) {
        localStorage.setItem('view_id', id);
        this.exchangeService.openViewProfile(id);
    };
    HomeTopProfileComponent.prototype.chunk = function (arr, chunkSize) {
        var R = [];
    ...
    HomeTopProfileComponent.prototype.revealContant = function () {
        this.reavel = true;
        this.usersService.revealContactInfo(localStorage.getItem('user_id'), localStorage.getItem('token'), this.result.id_user, function (res) { });
    };
    HomeTopProfileComponent.ctorParameters = function () { return [
    ...
    return HomeTopProfileComponent;
}());
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(exchangeService, toastr, usersService, router) {
        this.exchangeService = exchangeService;
        this.toastr = toastr;
        this.usersService = usersService;
        this.router = router;
    ...
    HomeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.exchangeService.viewProfileOpenObserver.subscribe(function (id) {
            if (id != "") {
                _this.showAD = true;
            }
        });
        this.exchangeService.openHomePageObserver.subscribe(function (open) {
            _this.showAD = !open;
        });
        this.exchangeService.serchObserver.subscribe(function (searchKey) {
            if (searchKey != null) {
        ...
        this.usersService.getGirlsService(localStorage.getItem('user_id'), localStorage.getItem('token'), function (services) {
    ...
    HomeComponent.prototype.search = function () {
        ...
        this.usersService.getTopProfile(localStorage.getItem('user_id'), localStorage.getItem('token'), infor.state, infor.name, infor.ageFrom, infor.ageTo, infor.heightFrom, infor.heightTo, infor.location, services, function (resTopProfile) {
            if (resTopProfile.success == 1) {
                _this.searchResult = resTopProfile.data;
                try {
                    var phone_hidden_number = _this.searchResult.contact_mobile.substring(0, 3) + "XXXX";
                    _this.searchResult.contact_mobile_unreveal = phone_hidden_number;
                }
                catch (error) {
                }
                _this.usersService.getProfileList(localStorage.getItem('user_id'), localStorage.getItem('token'), infor.state, infor.name, infor.ageFrom, infor.ageTo, infor.heightFrom, infor.heightTo, infor.location, services, function (resProfiles) {
                    if (resProfiles.success == 1) {
                        _this.profilesResult = resProfiles.data;
                        _this.usersService.getHistoryList(localStorage.getItem('user_id'), localStorage.getItem('token'), function (resHistory) {
                            if (resHistory.success == 1) {
                                setTimeout(function () {
                                    _this.exchangeService.setLoading(false);
                                }, 1000);
                                _this.historyResult = resHistory.data;
                            }
                            else if (resHistory.success == 0) {
                                _this.toastr.error(resProfiles.message);
                            }
                ...
                _this.toastr.error(resTopProfile.message);
            }
    ...
    HomeComponent.prototype.initRecent = function () {
        var _this = this;
        this.usersService.getHistoryList(localStorage.getItem('user_id'), localStorage.getItem('token'), function (resHistory) {
            if (resHistory.success == 1) {
                _this.historyResult = resHistory.data;
            }
            else if (resHistory.success == -1) {
...
var MainComponent = /** @class */ (function () {
    function MainComponent(exchangeService, router, usersService) {
        this.exchangeService = exchangeService;
        this.router = router;
        this.usersService = usersService;
        this.home = false;
    ...
    MainComponent.prototype.ngOnInit = function () {
        ...
        this.usersService.getLiveStatus(localStorage.getItem('user_id'), localStorage.getItem('token'), function (res) {
            if (res.success == 1) {
                _this.live = res.data.islive;
            }
            else if (res.success == -1) {
                _this.router.navigate['sign'];
            }
            _this.exchangeService.usernameInitObserver.subscribe(function (username) {
                _this.username = username;
            });
        });
        this.exchangeService.userStatus.subscribe(function (status) {
            _this.onSelect(status);
        });
        this.exchangeService.loadingObserver.subscribe(function (status) {
        ...
        this.exchangeService.changeThumbnailObserver.subscribe(function (change) {
            if (change)
                _this.updateThumbnail();
        });
    };
    MainComponent.prototype.updateThumbnail = function () {
        var _this = this;
        this.usersService.getProfileImage(localStorage.getItem('user_id'), localStorage.getItem('token'), localStorage.getItem('user_id'), function (res) {
            if (res.success == 1) {
                _this.imsUrl = _this.usersService.BASE_URL + res.data.imgurl;
            }
            else if (res.success == -1) {
                _this.router.navigate['sign'];
            }
    ...
    MainComponent.prototype.selectState = function (id) {
        $('#' + id).addClass("active");
    ...
    MainComponent.prototype.onSelect = function (id) {
        this.contents = {
            'nav0': false,
            'nav1': false,
            'nav2': false
    ...
    MainComponent.prototype.openHome = function () {
        var _this = this;
        this.home = true;
        this.exchangeService.openHomePage(true);
        this.usersService.getMyProfileDetails(localStorage.getItem('user_id'), localStorage.getItem('token'), function (details) {
            if (details.success == 1) {
                _this.states.forEach(function (element) {
                    if (details.data.locationInfo.state == element.name) {
                        ...
                        _this.currentState = $('#' + id).text();
                        _this.exchangeService.goSearch(_this.currentState);
                    }
                });
            }
    ...
    MainComponent.prototype.openView = function () {
    ...
    MainComponent.prototype.openEdit = function () {
        this.exchangeService.changeUserStatus("nav1");
        this.home = false;
    };
    MainComponent.prototype.openPaymentView = function () {
    ...
    MainComponent.prototype.changeLiveStatus = function (event) {
        this.live = event;
    };
...
var AvatarUploadComponent = /** @class */ (function () {
    function AvatarUploadComponent(dialog, exchangeService, userservice, router) {
        this.dialog = dialog;
        this.exchangeService = exchangeService;
    ...
    AvatarUploadComponent.prototype.initAvatar = function () {
        var _this = this;
        this.userservice.getProfileImage(localStorage.getItem('user_id'), localStorage.getItem('token'), localStorage.getItem('user_id'), function (res) {
            if (res.success == 1) {
                _this.data.croppedImage = res.data.imgcode;
            }
            else if (res.success == -1) {
                _this.router.navigate['sign'];
            }
    ...
    AvatarUploadComponent.prototype.selectImage = function () {
        this.exchangeService.closedUploadDlg(false);
        this.old_src = this.data.croppedImage;
        var dialogRef = this.dialog.open(_select_image_dialog_select_image_dialog_component__WEBPACK_IMPORTED_MODULE_3__["SelectImageDialogComponent"], { data: this.data });
        this.exchangeService.selectDlgStatus.subscribe(function (close) {
            if (close == true) {
                // this.initAvatar();
                dialogRef.close();
            }
...
var ChangeEmailDialogComponent = /** @class */ (function () {
    function ChangeEmailDialogComponent(dialogRef, data, formBuilder, exchangeService, toastr, usersService, router) {
    ...
    ChangeEmailDialogComponent.prototype.ngOnInit = function () {
        this.registerForm = this.formBuilder.group({
            email: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]
        });
    };
    Object.defineProperty(ChangeEmailDialogComponent.prototype, "f_up", {
        get: function () {
            return this.registerForm.controls;
        },
        enumerable: true,
    ...
    ChangeEmailDialogComponent.prototype.onChangeEmail = function () {
        var _this = this;
        ...
        var userInfo = this.registerForm.value;
        this.usersService.changeEmail(localStorage.getItem('user_id'), localStorage.getItem('token'), userInfo.email, function (res) {
            if (res.success == 1) {
            ...
            _this.exchangeService.closeChangeEmail(true);
        });
        this.exchangeService.refreshEditPage(true);
    };
    ChangeEmailDialogComponent.ctorParameters = function () { return [
...
var ChangeInfoComponent = /** @class */ (function () {
    function ChangeInfoComponent(dialog, exchangeService, usersService) {
        this.dialog = dialog;
        this.exchangeService = exchangeService;
        this.usersService = usersService;
        this.selected = 'Min';
    ...
    ChangeInfoComponent.prototype.clickLabelOn = function () {
        $(".switch_main").click();
    };
    ChangeInfoComponent.prototype.clickLabelOff = function () {
        $(".switch_main").click();
    };
    ChangeInfoComponent.prototype.onChange = function ($event) {
        this.on = $event;
    };
    ChangeInfoComponent.prototype.openChangeLocationDialog = function () {
        this.exchangeService.closeChangeLocation(false);
        var dialogRef = this.dialog.open(_change_location_dialog_change_location_dialog_component__WEBPACK_IMPORTED_MODULE_4__["ChangeLocationDialogComponent"], {
            data: {
                latitude: this.userinfo.data.locationInfo.latitude,
                longitude: this.userinfo.data.locationInfo.longitude,
            }
        });
        this.exchangeService.changeLocationObserver.subscribe(function (close) {
            if (close) {
                dialogRef.close();
            }
        });
    };
    ChangeInfoComponent.prototype.openChangePsswordDialog = function () {
        this.exchangeService.closeChangePassword(false);
        var dialogRef = this.dialog.open(src_app_pickadove_nav_contents_edit_change_info_change_pass_dialog_change_pass_dialog_component__WEBPACK_IMPORTED_MODULE_5__["ChangePassDialogComponent"], {
            width: '300px',
            data: {}
        });
        this.exchangeService.changePasswordObserver.subscribe(function (close) {
            if (close) {
                dialogRef.close();
            }
        });
    };
    ChangeInfoComponent.prototype.openChangenNameDialog = function () {
        this.exchangeService.closeChangeName(false);
        var dialogRef = this.dialog.open(_change_name_dialog_change_name_dialog_component__WEBPACK_IMPORTED_MODULE_6__["ChangeNameDialogComponent"], {
            width: '300px',
            data: {
        ...
        this.exchangeService.changeNameObserver.subscribe(function (close) {
            if (close) {
                dialogRef.close();
            }
        });
    };
    ChangeInfoComponent.prototype.openChangeEmailDialog = function () {
        this.exchangeService.closeChangeEmail(false);
        var dialogRef = this.dialog.open(_change_email_dialog_change_email_dialog_component__WEBPACK_IMPORTED_MODULE_7__["ChangeEmailDialogComponent"], {
            width: '300px',
            data: { email: this.userinfo.data.email }
        });
        this.exchangeService.changeEmailObserver.subscribe(function (close) {
            if (close) {
                dialogRef.close();
            }
        });
    };
    ChangeInfoComponent.ctorParameters = function () { return [
        { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
        { type: src_app_service_data_exchange_service__WEBPACK_IMPORTED_MODULE_3__["DataExchangeService"] },
...
var ChangeLocationDialogComponent = /** @class */ (function () {
    function ChangeLocationDialogComponent(data, exchangeService, usersService, toastr, router) {
        this.data = data;
        this.exchangeService = exchangeService;
        this.usersService = usersService;
        this.toastr = toastr;
    ...
    ChangeLocationDialogComponent.prototype.ngOnInit = function () {
    };
    ChangeLocationDialogComponent.prototype.onAutocompleteSelected = function (result) {
        var _this = this;
        result.address_components.forEach(function (element) {
            if (element.types[0] != null && element.types[0].indexOf("administrative_area_level") > -1) {
                _this.state = element.short_name;
            }
            if (element.types[0] != null && element.types[0] == "locality") {
                _this.address = element.short_name;
            }
        });
    };
    ChangeLocationDialogComponent.prototype.onLocationSelected = function (location) {
        this.data.latitude = location.latitude;
        this.data.longitude = location.longitude;
    };
    ChangeLocationDialogComponent.prototype.changeLocation = function () {
        var _this = this;
        if ($("input").val() == null && $("input").val() == "") {
            return;
        }
        this.exchangeService.setLoading(true);
        this.usersService.changeLocation(localStorage.getItem('user_id'), localStorage.getItem('token'), this.data.latitude, this.data.longitude, this.address, this.state, function (res) {
            if (res.success == 1) {
                _this.toastr.success(res.message);
    ...
    ChangeLocationDialogComponent.prototype.cancel = function () {
    };
    ChangeLocationDialogComponent.ctorParameters = function () { return [
    ...
    return ChangeLocationDialogComponent;
}());
...
var ChangeNameDialogComponent = /** @class */ (function () {
    function ChangeNameDialogComponent(dialogRef, data, exchangeService, formBuilder, usersService, toastr, router) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.exchangeService = exchangeService;
        this.formBuilder = formBuilder;
    ...
    ChangeNameDialogComponent.prototype.ngOnInit = function () {
        this.registerForm = this.formBuilder.group({
            firstname: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            lastname: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]
        });
    };
    Object.defineProperty(ChangeNameDialogComponent.prototype, "f_up", {
        get: function () {
            return this.registerForm.controls;
        },
        enumerable: true,
    ...
    ChangeNameDialogComponent.prototype.onChangeName = function () {
        var _this = this;
        this.isRegisterd = true;
        // stop here if form is invalid
        if (this.registerForm.invalid) {
        ...
        this.exchangeService.setLoading(true);
        var userInfo = this.registerForm.value;
        this.usersService.changeName(localStorage.getItem('user_id'), localStorage.getItem('token'), userInfo.firstname, userInfo.lastname, function (res) {
            if (res.success == 1) {
                _this.toastr.success(res.message);
                _this.exchangeService.refreshEditPage(true);
            }
            ...
            _this.exchangeService.closeChangeName(true);
        });
    };
...
var ChangePassDialogComponent = /** @class */ (function () {
    function ChangePassDialogComponent(route, formBuilder, exchangeService, usersService, router, toastr) {
        this.route = route;
        this.formBuilder = formBuilder;
        this.exchangeService = exchangeService;
        this.usersService = usersService;
    ...
    ChangePassDialogComponent.prototype.ngOnInit = function () {
        this.registerForm = this.formBuilder.group({
    ...
    Object.defineProperty(ChangePassDialogComponent.prototype, "f_up", {
        get: function () {
            return this.registerForm.controls;
        },
        enumerable: true,
    ...
    ChangePassDialogComponent.prototype.onChangePassword = function () {
        var _this = this;
        this.signup = true;
        // stop here if form is invalid
        if (this.registerForm.invalid) {
        ...
        var userInfo = this.registerForm.value;
        this.exchangeService.setLoading(true);
        this.usersService.changePassword(localStorage.getItem('user_id'), userInfo.oldPassword, userInfo.password, localStorage.getItem('token'), function (res) {
            if (res.success == 1) {
                _this.toastr.success(res.message);
                _this.exchangeService.refreshEditPage(true);
            }
    ...
    ChangePassDialogComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
        { type: src_app_service_data_exchange_service__WEBPACK_IMPORTED_MODULE_7__["DataExchangeService"] },
        { type: _service_users_service__WEBPACK_IMPORTED_MODULE_4__["UsersService"] },
    ...
    return ChangePassDialogComponent;
}());
...
var CommentsChatComponent = /** @class */ (function () {
    function CommentsChatComponent(formBuilder) {
        this.formBuilder = formBuilder;
        this.submit = false;
        this.comments = [];
    }
    CommentsChatComponent.prototype.ngOnInit = function () {
    ...
    Object.defineProperty(CommentsChatComponent.prototype, "f", {
        get: function () {
    ...
    CommentsChatComponent.prototype.onSubmit = function () {
        this.submit = true;
        // stop here if form is invalid
    ...
    CommentsChatComponent.prototype.addEmoji = function (event) {
        var text = $(".chat-contnet-input").val() + event.emoji.native;
        $(".chat-contnet-input").val(text);
    };
    CommentsChatComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
    ]; };
...
var CommentsComplainComponent = /** @class */ (function () {
    function CommentsComplainComponent(formBuilder) {
        this.formBuilder = formBuilder;
        this.submit = false;
        this.comments = [];
    }
    CommentsComplainComponent.prototype.ngOnInit = function () {
        this.submitForm = this.formBuilder.group({
            nickName: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            content: [''],
        });
    };
    Object.defineProperty(CommentsComplainComponent.prototype, "f", {
        get: function () {
            return this.submitForm.controls;
        },
        enumerable: true,
    ...
    CommentsComplainComponent.prototype.onSubmit = function () {
        this.submit = true;
        // stop here if form is invalid
        if (this.submitForm.invalid) {
            return;
    ...
    CommentsComplainComponent.prototype.addEmoji = function (event) {
        var text = $(".chat-contnet-input").val() + event.emoji.native;
        $(".chat-contnet-input").val(text);
    };
    CommentsComplainComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
    ]; };
    ...
    return CommentsComplainComponent;
}());
...
var EditInfoComponent = /** @class */ (function () {
    ...
    EditInfoComponent.prototype.changeValue = function (event) {
        this.fields[event.index].selected = event.val;
        this.fields[event.index].error = false;
    };
    EditInfoComponent.prototype.changeOtherValue = function (event) {
        this.userinfo[event.index] = event.val;
        this.userinfo[event.index + "_error"] = false;
    };
    EditInfoComponent.prototype.changeOtherContact = function (event) {
...
var EditComponent = /** @class */ (function () {
    function EditComponent(exchangeService, usersService, toastr, router) {
        this.exchangeService = exchangeService;
        this.usersService = usersService;
        this.toastr = toastr;
        this.router = router;
    ...
    EditComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.init();
        this.exchangeService.reFreshEditObserver.subscribe(function (refresh) {
            if (refresh) {
                _this.init();
            }
        });
    };
    EditComponent.prototype.init = function () {
        var _this = this;
        setTimeout(function () {
            _this.exchangeService.setLoading(true);
        }, 100);
        this.usersService.getWorkHours(localStorage.getItem('user_id'), localStorage.getItem('token'), function (hours) {
            if (hours.success == 0) {
                return;
            }
            ...
            _this.workHours = hours.data;
            _this.workHours.forEach(function (schedul) {
                var week = [];
                _this.week.forEach(function (day) {
                    week.push(day);
                });
                var hourFrom = [];
                var hourTo = [];
                if (schedul.isPmFrom == schedul.isPmTo) {
                    _this.hour.forEach(function (element, index) {
                ...
                var formatFrom = [];
                var formatTo = [];
                _this.timeFormat.forEach(function (element, index) {
            ...
            _this.usersService.getAdminFields(localStorage.getItem('user_id'), localStorage.getItem('token'), function (adminfields) {
                ...
                _this.usersService.getMyProfileDetails(localStorage.getItem('user_id'), localStorage.getItem('token'), function (details) {
                    if (details.success == 1) {
                        var selected = "";
                        _this.details = details;
                        _this.details_data = details.data;
                        _this.details_data.birthday_error = false;
                        _this.details_data.height_error = false;
                        console.log(_this.details_data);
                        _this.details_data.galleries.forEach(function (element) {
                            element.imgurl = _this.usersService.BASE_URL + element.imgurl;
                        });
                        console.log(_this.details_data);
                        _this.exchangeService.InitUsername(_this.details_data.firstname + " " + _this.details_data.lastname);
                        adminfields.data.forEach(function (element) {
                            var BreakException = {};
                            try {
                                details.data.adminFields.forEach(function (field) {
    ...
    EditComponent.prototype.completeProfile = function () {
        var _this = this;
        var errorCount = 0;
        ...
        var workhours = [];
        this.workHours.forEach(function (element) {
            var schedul = {
                "day": element.w_day,
                "from": element.w_from,
                "to": element.w_to,
        ...
        var adminFields = [];
        this.adminFields.forEach(function (element) {
        ...
        var otherContacts = [];
        this.details_data.otherContacts.forEach(function (element) {
        ...
        if (errorCount > 0)
            return;
        this.usersService.completeProfile(user_id, token, birthday, height, mobile, wechat, whatsapp, preferred, workhours, adminFields, otherContacts, function (res) {
            if (res.success == 1) {
                _this.toastr.success(res.message);
                _this.exchangeService.refreshEditPage(true);
            }
...
var PhotoGalleryComponent = /** @class */ (function () {
    function PhotoGalleryComponent(exchangeService, toastr, usersService, router) {
        this.exchangeService = exchangeService;
        this.toastr = toastr;
        this.usersService = usersService;
        this.router = router;
    ...
    PhotoGalleryComponent.prototype.preview = function (files) {
        var _this = this;
        if (files.length === 0)
            return;
        ...
        reader.onload = function (_event) {
            ...
            _this.galleries.push(data);
            //call api
            _this.exchangeService.setLoading(true);
            _this.usersService.uploadGallery(localStorage.getItem('user_id'), localStorage.getItem('token'), files[0], function (res) {
                if (res.success == 1) {
                    _this.toastr.success(res.message);
                    _this.exchangeService.refreshEditPage(true);
                }
    ...
    PhotoGalleryComponent.prototype.selectImage = function () {
        $(".inputFile").click();
    };
    PhotoGalleryComponent.prototype.deleteIamge = function (id) {
        var _this = this;
        this.exchangeService.setLoading(true);
        this.usersService.deleteGallery(localStorage.getItem('user_id'), localStorage.getItem('token'), id, function (res) {
            if (res.success == 1) {
                _this.toastr.success(res.message);
                _this.exchangeService.refreshEditPage(true);
            }
    ...
    PhotoGalleryComponent.prototype.onLock = function (event) {
        var _this = this;
        this.exchangeService.setLoading(true);
        this.usersService.lockGallery(localStorage.getItem('user_id'), localStorage.getItem('token'), event.id, event.val, function (res) {
            if (res.success == 1) {
                _this.toastr.success(res.message);
                _this.exchangeService.refreshEditPage(true);
            }
...
var SelectImageDialogComponent = /** @class */ (function () {
    function SelectImageDialogComponent(data, exchangeService, usersService, toastr, router) {
        this.data = data;
        this.exchangeService = exchangeService;
        this.usersService = usersService;
        this.toastr = toastr;
    ...
    SelectImageDialogComponent.prototype.ngOnInit = function () {
    };
    SelectImageDialogComponent.prototype.fileChangeEvent = function (event) {
        this.imageChangedEvent = event;
        this.file = event.target.files[0];
    };
    SelectImageDialogComponent.prototype.imageCropped = function (event) {
        this.data.croppedImage = event.base64;
        this.imgcode = event.base64;
        this.file = event.file;
        this.selected = true;
    };
    SelectImageDialogComponent.prototype.imageLoaded = function () {
        // show cropper
    };
    SelectImageDialogComponent.prototype.cropperReady = function () {
        // cropper ready
    };
    SelectImageDialogComponent.prototype.loadImageFailed = function () {
        this.message = "Only images are supported.";
    };
    SelectImageDialogComponent.prototype.selectImage = function () {
        $('#upload_input').click();
    };
    SelectImageDialogComponent.prototype.uploadImage = function () {
        var _this = this;
        this.exchangeService.setLoading(true);
        this.usersService.uploadProfileImage(localStorage.getItem('user_id'), localStorage.getItem('token'), this.file, this.imgcode, function (res) {
            if (res.success == 1) {
                _this.usersService.updateImageCode(localStorage.getItem('user_id'), localStorage.getItem('token'), _this.imgcode, function (res) {
                    if (res.success == 1) {
                        _this.toastr.success(res.message);
                        _this.exchangeService.changeThumbnail(true);
                        _this.exchangeService.closedUploadDlg(true);
                    }
                    else if (res.success == -1) {
                        _this.router.navigate['sign'];
                    }
    ...
    SelectImageDialogComponent.ctorParameters = function () { return [
    ...
    return SelectImageDialogComponent;
}());
...
var ServiceSelectionComponent = /** @class */ (function () {
    function ServiceSelectionComponent(userservice, toastr, router) {
        this.userservice = userservice;
        this.toastr = toastr;
        this.router = router;
        this.services = [];
    ...
    ServiceSelectionComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userservice.getGirlsService(localStorage.getItem('user_id'), localStorage.getItem('token'), function (services) {
    ...
    ServiceSelectionComponent.prototype.click = function (event) {
        var _this = this;
        this.userservice.saveGirlService(localStorage.getItem('user_id'), localStorage.getItem('token'), this.services[event.index].id_services, event.val ? 1 : 0, function (res) {
            if (res.success == 1) {
                _this.toastr.success(res.message);
            }
            else if (res.success == -1) {
    ...
    ServiceSelectionComponent.ctorParameters = function () { return [
...
var WorkHourComponent = /** @class */ (function () {
    function WorkHourComponent(dataExchange) {
    ...
    WorkHourComponent.prototype.ngOnInit = function () { };
    WorkHourComponent.prototype.addHour = function () {
        var week = [];
        this.week.forEach(function (element) {
            week.push(element);
        });
        var hourFrom = [];
        var hourTo = [];
        this.hour.forEach(function (element) {
            hourFrom.push(element);
            hourTo.push(element);
        });
        var formatFrom = [];
        var formatTo = [];
        this.timeFormat.forEach(function (element) {
            formatFrom.push(element);
            formatTo.push(element);
        });
        var schedule = {
    ...
    WorkHourComponent.prototype.selectHour = function (event) {
        event.object.hourTo = [];
    ...
    WorkHourComponent.prototype.selectPM = function (event) {
    ...
    WorkHourComponent.prototype.selectPMTo = function (object) {
        object.hourTo = [];
        if (object.isPmFrom == object.isPmTo) {
            this.hour.forEach(function (element, index) {
    ...
    WorkHourComponent.ctorParameters = function () { return [
        { type: src_app_service_data_exchange_service__WEBPACK_IMPORTED_MODULE_2__["DataExchangeService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
var PreviewAvatarComponent = /** @class */ (function () {
    function PreviewAvatarComponent(exchangeService, userservice, router) {
        this.exchangeService = exchangeService;
        this.userservice = userservice;
        this.router = router;
        this.data = { croppedImage: "../../../../assets/img/avatar.png" };
    }
    PreviewAvatarComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userservice.getMyProfileDetails(localStorage.getItem('user_id'), localStorage.getItem('token'), function (details) {
            if (details.success == 1) {
                _this.userinfo = details.data;
                _this.userservice.getProfileImage(localStorage.getItem('user_id'), localStorage.getItem('token'), localStorage.getItem('user_id'), function (res) {
                    if (res.success == 1) {
                        _this.data.croppedImage = res.data.imgcode;
                        console.log(_this.data.croppedImage);
                    }
                    else if (res.success == -1) {
                        _this.router.navigate['sign'];
                    }
    ...
    PreviewAvatarComponent.ctorParameters = function () { return [
        { type: src_app_service_data_exchange_service__WEBPACK_IMPORTED_MODULE_2__["DataExchangeService"] },
        { type: src_app_service_users_service__WEBPACK_IMPORTED_MODULE_3__["UsersService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
    ]; };
...
var PreviewCommentsChatComponent = /** @class */ (function () {
    function PreviewCommentsChatComponent(exchangeService, formBuilder, toastr, usersService, router) {
        this.exchangeService = exchangeService;
        this.formBuilder = formBuilder;
        this.toastr = toastr;
        this.usersService = usersService;
    ...
    PreviewCommentsChatComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.submitForm = this.formBuilder.group({
            nickName: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            content: [''],
        ...
        //call api
        // this.exchangeService.setLoading(true);
        this.usersService.getComments(localStorage.getItem('user_id'), localStorage.getItem('token'), localStorage.getItem('user_id'), 0, function (res) {
            if (res.success == 1) {
    ...
    Object.defineProperty(PreviewCommentsChatComponent.prototype, "f", {
        get: function () {
            return this.submitForm.controls;
        },
        enumerable: true,
    ...
    PreviewCommentsChatComponent.prototype.onSubmit = function () {
        this.submit = true;
        // stop here if form is invalid
        if (this.submitForm.invalid) {
            return;
    ...
    PreviewCommentsChatComponent.prototype.addEmoji = function (event) {
        var text = $(".chat-contnet-input").val() + event.emoji.native;
        $(".chat-contnet-input").val(text);
    };
    PreviewCommentsChatComponent.ctorParameters = function () { return [
        { type: src_app_service_data_exchange_service__WEBPACK_IMPORTED_MODULE_3__["DataExchangeService"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"] },
        { type: src_app_service_users_service__WEBPACK_IMPORTED_MODULE_5__["UsersService"] },
    ...
    return PreviewCommentsChatComponent;
}());
...
var PreviewCommentsComplaintsComponent = /** @class */ (function () {
    function PreviewCommentsComplaintsComponent(exchangeService, formBuilder, toastr, usersService, router) {
        this.exchangeService = exchangeService;
        this.formBuilder = formBuilder;
        this.toastr = toastr;
        this.usersService = usersService;
    ...
    PreviewCommentsComplaintsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.submitForm = this.formBuilder.group({
            nickName: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            content: [''],
        ...
        //call api
        // this.exchangeService.setLoading(true);
        this.usersService.getComments(localStorage.getItem('user_id'), localStorage.getItem('token'), localStorage.getItem('user_id'), 1, function (res) {
            if (res.success == 1) {
                _this.comments = res.data;
                console.log(_this.comments);
            }
    ...
    Object.defineProperty(PreviewCommentsComplaintsComponent.prototype, "f", {
        get: function () {
            return this.submitForm.controls;
        },
        enumerable: true,
    ...
    PreviewCommentsComplaintsComponent.prototype.onSubmit = function () {
        this.submit = true;
        // stop here if form is invalid
        if (this.submitForm.invalid) {
            return;
    ...
    PreviewCommentsComplaintsComponent.prototype.addEmoji = function (event) {
        var text = $(".chat-contnet-input").val() + event.emoji.native;
        $(".chat-contnet-input").val(text);
    };
    PreviewCommentsComplaintsComponent.ctorParameters = function () { return [
        { type: src_app_service_data_exchange_service__WEBPACK_IMPORTED_MODULE_4__["DataExchangeService"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"] },
        { type: src_app_service_users_service__WEBPACK_IMPORTED_MODULE_5__["UsersService"] },
    ...
    return PreviewCommentsComplaintsComponent;
}());
...
var PreviewCommentsComponent = /** @class */ (function () {
    function PreviewCommentsComponent() {
    }
    PreviewCommentsComponent.prototype.ngOnInit = function () {
    };
    ...
    return PreviewCommentsComponent;
}());
...
var PreviewImageGalleryComponent = /** @class */ (function () {
    function PreviewImageGalleryComponent(exchangeService, usersService, router) {
        this.exchangeService = exchangeService;
        this.usersService = usersService;
        this.router = router;
        this.images = [
    ...
    PreviewImageGalleryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.usersService.getMyProfileDetails(localStorage.getItem('user_id'), localStorage.getItem('token'), function (details) {
            if (details.success == 1) {
                _this.galleries = details.data.galleries;
            }
            else if (details.success == -1) {
                _this.router.navigate['sign'];
            }
    ...
    PreviewImageGalleryComponent.ctorParameters = function () { return [
        { type: src_app_service_data_exchange_service__WEBPACK_IMPORTED_MODULE_2__["DataExchangeService"] },
        { type: src_app_service_users_service__WEBPACK_IMPORTED_MODULE_3__["UsersService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
    ]; };
    ...
    return PreviewImageGalleryComponent;
}());
...
var PreviewPersionalInfoComponent = /** @class */ (function () {
    function PreviewPersionalInfoComponent(exchangeService, usersService, toastr, router) {
        this.exchangeService = exchangeService;
        this.usersService = usersService;
        this.toastr = toastr;
        this.router = router;
    }
    PreviewPersionalInfoComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () {
            _this.exchangeService.setLoading(true);
        }, 100);
        this.usersService.getMyProfileDetails(localStorage.getItem('user_id'), localStorage.getItem('token'), function (details) {
            if (details.success == 1) {
                _this.userinfo = details.data;
                _this.exchangeService.InitUsername(_this.userinfo.firstname + " " + _this.userinfo.lastname);
                setTimeout(function () {
                    _this.exchangeService.setLoading(false);
                }, 1000);
            }
    ...
    PreviewPersionalInfoComponent.ctorParameters = function () { return [
        { type: src_app_service_data_exchange_service__WEBPACK_IMPORTED_MODULE_2__["DataExchangeService"] },
        { type: src_app_service_users_service__WEBPACK_IMPORTED_MODULE_3__["UsersService"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }
    ...
    return PreviewPersionalInfoComponent;
}());
...
var PreviewProfileDetailsComponent = /** @class */ (function () {
    function PreviewProfileDetailsComponent(userservice, router) {
        this.userservice = userservice;
        this.router = router;
        this.services = [];
        this.data = {
    ...
    PreviewProfileDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userservice.getGirlsService(localStorage.getItem('user_id'), localStorage.getItem('token'), function (services) {
            if (services.success == 0) {
                return;
            ...
            services.data.forEach(function (element) {
                if (element.value) {
    ...
    PreviewProfileDetailsComponent.ctorParameters = function () { return [
        { type: src_app_service_users_service__WEBPACK_IMPORTED_MODULE_2__["UsersService"] },
    ...
    return PreviewProfileDetailsComponent;
}());
...
var PreviewWorkHourComponent = /** @class */ (function () {
    function PreviewWorkHourComponent(exchangeService, usersService, router) {
        this.exchangeService = exchangeService;
        this.usersService = usersService;
        this.router = router;
        this.week = [{ id: 0, name: 'SUN' }, { id: 1, name: 'MON' }, { id: 2, name: 'TUE' }, { id: 3, name: 'WED' }, { id: 4, name: 'THU' }, { id: 5, name: 'FRI' }, { id: 6, name: 'SAT' }];
    ...
    PreviewWorkHourComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () {
            _this.exchangeService.setLoading(true);
        }, 100);
        this.usersService.getWorkHours(localStorage.getItem('user_id'), localStorage.getItem('token'), function (hours) {
            ...
            hours.data.forEach(function (element) {
                var schedule = {
    ...
    PreviewWorkHourComponent.ctorParameters = function () { return [
        { type: src_app_service_data_exchange_service__WEBPACK_IMPORTED_MODULE_2__["DataExchangeService"] },
        { type: src_app_service_users_service__WEBPACK_IMPORTED_MODULE_3__["UsersService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
    ]; };
    ...
    return PreviewWorkHourComponent;
}());
...
var PickadoveComponent = /** @class */ (function () {
    function PickadoveComponent(exchangeService, router) {
        this.exchangeService = exchangeService;
        this.router = router;
    ...
    PickadoveComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () {
            _this.started = true;
        }, 2000);
        ...
        this.exchangeService.tokenObserver.subscribe(function (broken) {
            if (broken) {
                _this.verfication = false;
                _this.isVerified = false;
                _this.started = true;
                _this.exchangeService.goTosign(false);
            }
        });
        var status = localStorage.getItem('status');
        switch (status) {
    ...
    PickadoveComponent.ctorParameters = function () { return [
...
var LiveComponent = /** @class */ (function () {
    function LiveComponent(usersService, toastr, router) {
        this.usersService = usersService;
        this.toastr = toastr;
        this.router = router;
    ...
    LiveComponent.prototype.setLive = function () {
        var _this = this;
        if (this.liveStatus) {
            this.usersService.goLive(localStorage.getItem('user_id'), localStorage.getItem('token'), function (res) {
                if (res.success == 1) {
                    _this.toastr.success(res.message);
                    _this.liveStatus.emit(true);
                }
                else if (res.success == -1) {
                    _this.router.navigate['sign'];
                }
    ...
    LiveComponent.ctorParameters = function () { return [
        { type: src_app_service_users_service__WEBPACK_IMPORTED_MODULE_2__["UsersService"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
    ]; };
...
var NavigationComponent = /** @class */ (function () {
    function NavigationComponent(exchangeService, usersService) {
        this.exchangeService = exchangeService;
        this.usersService = usersService;
        this.navs = [
    ...
    NavigationComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.exchangeService.userStatus.subscribe(function (status) {
            _this.selectNav(status);
        });
    };
    NavigationComponent.prototype.selectNav = function (id) {
        // $("#"+id).addClass("active");
        // $('#navbarNav').removeClass("show");
...
var ViewProfileAvatarComponent = /** @class */ (function () {
    ...
    return ViewProfileAvatarComponent;
}());
...
var ViewProfileCommentsChatComponent = /** @class */ (function () {
    function ViewProfileCommentsChatComponent(exchangeService, formBuilder, toastr, usersService, router) {
        this.exchangeService = exchangeService;
        this.formBuilder = formBuilder;
        this.toastr = toastr;
        this.usersService = usersService;
    ...
    ViewProfileCommentsChatComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.submitForm = this.formBuilder.group({
            nickName: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            content: [''],
    ...
    Object.defineProperty(ViewProfileCommentsChatComponent.prototype, "f", {
        get: function () {
            return this.submitForm.controls;
        },
        enumerable: true,
    ...
    ViewProfileCommentsChatComponent.prototype.onSubmit = function () {
        this.submit = true;
        // stop here if form is invalid
        var iErrorCount = 0;
    ...
    ViewProfileCommentsChatComponent.prototype.addEmoji = function (event) {
        var text = $(".chat-contnet-input").val() + event.emoji.native;
        $(".chat-contnet-input").val(text);
        this.submitForm.controls.content.setErrors(null);
    };
    ViewProfileCommentsChatComponent.ctorParameters = function () { return [
        { type: src_app_service_data_exchange_service__WEBPACK_IMPORTED_MODULE_3__["DataExchangeService"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"] },
        { type: src_app_service_users_service__WEBPACK_IMPORTED_MODULE_5__["UsersService"] },
    ...
    return ViewProfileCommentsChatComponent;
}());
...
var ViewProfileCommentsComplaintsComponent = /** @class */ (function () {
    function ViewProfileCommentsComplaintsComponent(exchangeService, formBuilder, toastr, usersService, router) {
        this.exchangeService = exchangeService;
        this.formBuilder = formBuilder;
        this.toastr = toastr;
        this.usersService = usersService;
    ...
    ViewProfileCommentsComplaintsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.submitForm = this.formBuilder.group({
            nickName: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            content: [''],
    ...
    Object.defineProperty(ViewProfileCommentsComplaintsComponent.prototype, "f", {
        get: function () {
            return this.submitForm.controls;
        },
        enumerable: true,
    ...
    ViewProfileCommentsComplaintsComponent.prototype.onSubmit = function () {
        this.submit = true;
        // stop here if form is invalid
        var iErrorCount = 0;
        if ($(".nickname-input").val() == '') {
    ...
    ViewProfileCommentsComplaintsComponent.prototype.addEmoji = function (event) {
        var text = $(".chat-contnet-input").val() + event.emoji.native;
        $(".chat-contnet-input").val(text);
        this.submitForm.controls.content.setErrors(null);
    };
    ViewProfileCommentsComplaintsComponent.ctorParameters = function () { return [
        { type: src_app_service_data_exchange_service__WEBPACK_IMPORTED_MODULE_3__["DataExchangeService"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"] },
        { type: src_app_service_users_service__WEBPACK_IMPORTED_MODULE_5__["UsersService"] },
    ...
    return ViewProfileCommentsComplaintsComponent;
}());
...
var ViewProfileCommentsComponent = /** @class */ (function () {
    function ViewProfileCommentsComponent() {
    }
    ViewProfileCommentsComponent.prototype.ngOnInit = function () {
    };
    ...
    return ViewProfileCommentsComponent;
}());
...
var ViewProfileImageGalleryComponent = /** @class */ (function () {
    function ViewProfileImageGalleryComponent() {
    }
    ViewProfileImageGalleryComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return ViewProfileImageGalleryComponent;
}());
...
var ViewProfilePersionalInfoComponent = /** @class */ (function () {
    function ViewProfilePersionalInfoComponent(usersService) {
        this.usersService = usersService;
        this.data = {
            persion_ingo: {
                name: 'georgia smiths',
    ...
    ViewProfilePersionalInfoComponent.prototype.ngOnInit = function () {
    };
    ViewProfilePersionalInfoComponent.prototype.revealContant = function () {
        this.reavel = true;
        this.usersService.revealContactInfo(localStorage.getItem('user_id'), localStorage.getItem('token'), this.userInfo.id_user, function (res) { });
    };
    ViewProfilePersionalInfoComponent.ctorParameters = function () { return [
        { type: src_app_service_users_service__WEBPACK_IMPORTED_MODULE_2__["UsersService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return ViewProfilePersionalInfoComponent;
}());
...
var ViewProfileProfileDetailsComponent = /** @class */ (function () {
    function ViewProfileProfileDetailsComponent() {
        this.data = {
            about_me: "This is a dummy paragraph for display purposes only."
        };
    }
    ViewProfileProfileDetailsComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return ViewProfileProfileDetailsComponent;
}());
...
var ViewProfileWorkHourComponent = /** @class */ (function () {
    function ViewProfileWorkHourComponent() {
    }
    ViewProfileWorkHourComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return ViewProfileWorkHourComponent;
}());
...
var ViewProfileComponent = /** @class */ (function () {
    function ViewProfileComponent(exchangeService, userservice, router) {
        this.exchangeService = exchangeService;
        this.userservice = userservice;
        this.router = router;
        this.week = [{ id: 0, name: 'SUN' }, { id: 1, name: 'MON' }, { id: 2, name: 'TUE' }, { id: 3, name: 'WED' }, { id: 4, name: 'THU' }, { id: 5, name: 'FRI' }, { id: 6, name: 'SAT' }];
    ...
    ViewProfileComponent.prototype.init = function () {
        var _this = this;
        setTimeout(function () {
            _this.exchangeService.setLoading(true);
        }, 100);
    ...
    ViewProfileComponent.ctorParameters = function () { return [
        { type: src_app_service_data_exchange_service__WEBPACK_IMPORTED_MODULE_2__["DataExchangeService"] },
        { type: src_app_service_users_service__WEBPACK_IMPORTED_MODULE_3__["UsersService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
    ]; };
...
var AuthGuardAdminService = /** @class */ (function () {
    function AuthGuardAdminService(auth, router) {
        this.auth = auth;
        this.router = router;
    }
    AuthGuardAdminService.prototype.canActivate = function () {
    ...
    AuthGuardAdminService.ctorParameters = function () { return [
...
var AuthGuardUserService = /** @class */ (function () {
    function AuthGuardUserService(auth, router) {
        this.auth = auth;
        this.router = router;
    }
    AuthGuardUserService.prototype.canActivate = function () {
        if (!this.auth.isAuthenticated()) {
            this.router.navigate(['sign']);
            return false;
        }
    ...
    AuthGuardUserService.ctorParameters = function () { return [
        { type: _auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.isUserState = function () {
...
var DataExchangeService = /** @class */ (function () {
    ...
    DataExchangeService.prototype.changeMessage = function (email) {
        this.messageSource.next(email);
    };
    DataExchangeService.prototype.setLoading = function (load) {
        this.loading.next(load);
    };
    DataExchangeService.prototype.closedUploadDlg = function (close) {
        this.selectDlgSource.next(close);
    };
    DataExchangeService.prototype.cancelDlg = function (close) {
        this.canceledDlgSource.next(close);
    };
    DataExchangeService.prototype.changeUserStatus = function (status) {
        this.navSource.next(status);
    };
    DataExchangeService.prototype.openViewProfile = function (id) {
        this.viewPofileOpen.next(id);
    };
    DataExchangeService.prototype.openHomePage = function (open) {
        this.homePageOpen.next(open);
    };
    DataExchangeService.prototype.closeChangeLocation = function (access) {
        this.changeLocationDialog.next(access);
    };
    DataExchangeService.prototype.closeChangePassword = function (access) {
        this.changePasswordDialog.next(access);
    };
    DataExchangeService.prototype.closeChangeName = function (access) {
        this.changeNameDialog.next(access);
    };
    DataExchangeService.prototype.closeChangeEmail = function (access) {
        this.changeEmailDialog.next(access);
    };
    DataExchangeService.prototype.goTosign = function (broken) {
        this.token.next(broken);
    };
    DataExchangeService.prototype.goSearch = function (searchKey) {
        this.searchStart.next(searchKey);
    };
    DataExchangeService.prototype.changeThumbnail = function (change) {
        this.thumbnail.next(change);
    };
    DataExchangeService.prototype.setState = function (state) {
        this.homepage.next(state);
    };
    DataExchangeService.prototype.refreshEditPage = function (refresh) {
        this.refreshEdit.next(refresh);
    };
    DataExchangeService.prototype.InitUsername = function (username) {
...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.getArgHeaders = function () {
        var httpOptions = {
    ...
    UsersService.prototype.getTokenHeaders = function (token) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8',
                'Authorization': token
    ...
    UsersService.prototype.getImgTokenHeaders = function (token) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'Authorization': token
            })
    ...
    UsersService.prototype.getTokenJsonHeaders = function (token) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
    ...
    UsersService.prototype.signup = function (email, firstName, lastName, password, usertype, location, callback) {
        var params = {
            email: email,
            firstname: firstName,
            lastname: lastName,
    ...
    UsersService.prototype.signin = function (email, password, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('email', email)
    ...
    UsersService.prototype.verifyUser = function (user_id, code, token, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
            .set('code', code);
    ...
    UsersService.prototype.requestVerificationCode = function (user_id, token, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id);
    ...
    UsersService.prototype.forgot_password = function (email, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('email', email);
    ...
    UsersService.prototype.verifyResetKey = function (reset_key, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
    ...
    UsersService.prototype.resetPassword = function (user_id, password, reset_key, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
            .set('password', password)
            .set('reset_key', reset_key);
    ...
    UsersService.prototype.changePassword = function (user_id, previousPassword, newPassword, token, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
    ...
    UsersService.prototype.getMyProfileDetails = function (user_id, token, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id);
    ...
    UsersService.prototype.getProfileDetailsById = function (user_id, token, view_id, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
            .set('view_id', view_id);
    ...
    UsersService.prototype.getAdminFields = function (user_id, token, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id);
    ...
    UsersService.prototype.getWorkHours = function (user_id, token, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id);
    ...
    UsersService.prototype.getGirlsService = function (user_id, token, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id);
    ...
    UsersService.prototype.completeProfile = function (user_id, token, birthday, height, mobile, wechat, whatsapp, preferred, workhours, adminFields, otherContacts, callback) {
        var params = {
            user_id: user_id,
            birthday: birthday,
            height: height,
    ...
    UsersService.prototype.changeName = function (user_id, token, firstname, lastname, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
    ...
    UsersService.prototype.changeEmail = function (user_id, token, email, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
            .set('email', email);
    ...
    UsersService.prototype.changeLocation = function (user_id, token, latitude, longitude, address, state, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
    ...
    UsersService.prototype.saveGirlService = function (user_id, token, service_id, value, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
    ...
    UsersService.prototype.getTopProfile = function (user_id, token, state, name, ageFrom, ageTo, heightFrom, heightTo, location, services, callback) {
        var body = {
            'user_id': user_id,
            'state': state,
            'name': name,
    ...
    UsersService.prototype.getProfileList = function (user_id, token, state, name, ageFrom, ageTo, heightFrom, heightTo, location, services, callback) {
        var body = {
            'user_id': user_id,
            'state': state,
            'name': name,
    ...
    UsersService.prototype.getHistoryList = function (user_id, token, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id);
    ...
    UsersService.prototype.getProfileImage = function (user_id, token, view_id, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
            .set('view_id', view_id);
    ...
    UsersService.prototype.goLive = function (user_id, token, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id);
    ...
    UsersService.prototype.getLiveStatus = function (user_id, token, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id);
    ...
    UsersService.prototype.getOtherContacts = function (user_id, token, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id);
    ...
    UsersService.prototype.revealContactInfo = function (user_id, token, view_id, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
            .set('view_id', view_id);
    ...
    UsersService.prototype.uploadProfileImage = function (user_id, token, file, imgcode, callback) {
    ...
    UsersService.prototype.updateImageCode = function (user_id, token, imgcode, callback) {
        var uploadData = new FormData();
        uploadData.append('imgcode', imgcode);
        uploadData.append('user_id', user_id);
    ...
    UsersService.prototype.uploadGallery = function (user_id, token, file, callback) {
        var uploadData = new FormData();
        uploadData.append('file', file, file.name);
        uploadData.append('user_id', user_id);
    ...
    UsersService.prototype.deleteGallery = function (user_id, token, gallery_id, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
    ...
    UsersService.prototype.lockGallery = function (user_id, token, gallery_id, islock, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
            .set('gallery_id', gallery_id)
            .set('islock', islock);
    ...
    UsersService.prototype.getComments = function (user_id, token, commented_user, comment_type, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
    ...
    UsersService.prototype.getAdminUsersCount = function (user_id, token, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id);
    ...
    UsersService.prototype.getAdminProfile = function (user_id, token, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id);
    ...
    UsersService.prototype.getAdminUserList = function (user_id, token, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id);
    ...
    UsersService.prototype.changeAdminUserPassword = function (user_id, token, change_user_id, password, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
    ...
    UsersService.prototype.addAdminField = function (user_id, token, field_type, label, isrequired, combo, callback) {
        var params = {
            user_id: user_id,
    ...
    UsersService.prototype.deleteAdminField = function (user_id, token, adminfield_id, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
    ...
    UsersService.prototype.addAdminOtherContact = function (user_id, token, file, label, callback) {
        var uploadData = new FormData();
        uploadData.append('file', file, file.name);
    ...
    UsersService.prototype.deleteAdminOtherContact = function (user_id, token, othercontact_id, callback) {
        var httpBody = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('user_id', user_id)
...
var VerificationComponent = /** @class */ (function () {
    function VerificationComponent(formBuilder, UsersService, exchangeService, router) {
        this.formBuilder = formBuilder;
        this.UsersService = UsersService;
        this.exchangeService = exchangeService;
        this.router = router;
    ...
    Object.defineProperty(VerificationComponent.prototype, "f", {
        // convenience getter for easy access to form fields
        get: function () {
    ...
    VerificationComponent.prototype.onVerify = function () {
        var _this = this;
        this.verified = true;
        // stop here if form is invalid
        ...
        this.UsersService.verifyUser(localStorage.getItem('user_id'), this.verifyForm.value.code, localStorage.getItem('token'), function (res) {
            if (res.success == 1) {
                localStorage.setItem('status', '1');
                _this.router.navigate(['']);
            }
            else {
                _this.error_message = res.message;
            }
        });
    };
    VerificationComponent.prototype.requestVierication = function () {
        var _this = this;
        this.UsersService.requestVerificationCode(localStorage.getItem('user_id'), localStorage.getItem('token'), function (res) {
            $('input').val(null);
            if (res.success == 1) {
                _this.error_message = "";
            }
